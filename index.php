...
<html>
	<head>
		<title>Secure E-Government Website</title>
	...
	<body>
		<!--start-wrap-->
			...
			<div class="header">
				...
				<!--start-logo-->
				<div class="logo">
					<a href="index.html" style="font-size: 30px;">Secure E-Government Website</a>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
			...
			<!--start-image-slider---->
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li><img src="images/s1.jfif" alt=""></li>
					      <li><img src="images/s2.jfif" alt=""></li>
					      <li><img src="images/s1.jfif" alt=""></li>
					    </ul>
						 <!-- Slideshow 2 -->
					</div>
		    ...
		    <div class="content-grids">
				...
				<div class="listview_1_of_3 images_1_of_3">
					<div class="listimg listimg_1_of_2">
						  <img src="images/grid-img123.png">
					</div>
				...
				<div class="listview_1_of_3 images_1_of_3">
					<div class="listimg listimg_1_of_2">
						  <img src="images/grid-img234.jfif">
					</div>
					<div class="text list_1_of_2">
						  <h3>Doctors Login</h3>
